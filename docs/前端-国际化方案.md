...
[专属化国际化](http://pap-i18n.online.app.yyuap.com/I18n/i18n/index.html#/)[在线]()[生成]()[资源]()<br />
...
> 1. 多语访问方式:
> 
通过http://ip:8080?_lang=zh-CN/zh-TW/en-US 进行多语切换、cookie均可。
...
2. 提供 **ac-lang-cn **组件  [如果使用](https://package.yonyoucloud.com/#/package/YWMtbGFuZy1jbg==)
...
3. **mdf-app/src/web/client/index.jsx 文件中天下如下代码**
