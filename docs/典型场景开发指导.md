...
**2、在Excel中对应的容器配置cStyle属性**<br />![image.png](http://design.yonyoucloud.com/static/yuque/0/2019/png/271337/1554204299639-973dc01f-ea7c-4966-96b4-d667e2d0d46d.png#align=left&display=inline&height=242&name=image.png&originHeight=242&originWidth=1514&size=47370&status=done&width=1514)
...
**2、UI元数据的Excel配置**<br />配置表格类型(cContorlType)为TreeTable<br />![](http://design.yonyoucloud.com/static/yuque/0/2019/png/271337/1554342865449-38bfeee8-c831-49a4-97d9-bbca0f76af28.png#align=left&display=inline&height=86&originHeight=212&originWidth=1830&status=done&width=746)
